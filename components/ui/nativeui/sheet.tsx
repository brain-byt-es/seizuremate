...
const Sheet = React.forwardRef<View, SheetProps>(
  (
    ...
    const getSheetDimensions = React.useCallback(() => {
      switch (side) {
        case "left":
        case "right":
          return {
    ...
    }, [backdropOpacity, translateValue, getInitialPosition, getTargetPosition]);
    ...
    }, [backdropOpacity, translateValue, onClose, getInitialPosition]);
    ...
    const getSheetPosition = React.useCallback(() => {
      switch (side) {
        case "left":
    ...
    const getSafeAreaEdges = React.useCallback((): Edge[] => {
      switch (side) {
        case "left":
        case "right":
          return ["top", "bottom"];
