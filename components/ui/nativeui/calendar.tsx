...
const CalendarHeader = React.memo(({
  ...
  <View className="flex-row items-center justify-between mb-4">
    ...
    {enableQuickMonthYear ? ( // TODO: The color-primary is not working on the icon
      <Pressable
      ...
      >
        ...
        <Ionicons name="chevron-down" size={20} color="hsl(var(--primary))" />
      </Pressable>
    ) : (
      <Text className="text-xl font-semibold text-foreground">
        {format(currentDate, "MMMM yyyy", { locale: enUS })}
  ...
  return (
    <Pressable
      ...
      className={cn(
        ...
        isTodayDate && !isSelected && "border border-muted-foreground rounded-lg",
...
export function Calendar({
  ...
  return (
    <View className={cn("bg-background rounded-2xl self-center w-full max-w-md", className)}>
      <View className="p-4">
        <CalendarHeader
